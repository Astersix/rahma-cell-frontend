										...
										<tbody className="divide-y divide-neutral-200 text-neutral-800">
											{items.map((it: any, idx: number) => (
												<tr key={idx}>
													...
													<td className="px-3 py-2">{it?.variant_name || it?.variant || '-'}</td>
					...
					<div className="space-y-6">
						...
						<Card className="p-0">
							...
							<div className="px-4 pb-4 text-xs text-neutral-700">
								...
								<select className="mb-3 w-full rounded-md border border-neutral-300 px-3 py-2 text-xs">
								...
								<Button fullWidth className="bg-red-600 hover:bg-red-700 active:bg-red-800" onClick={() => navigate('/admin/orders', { state: { refreshAfter: 'status-update' } })}>Simpan status</Button>
							</div>
						</Card>
